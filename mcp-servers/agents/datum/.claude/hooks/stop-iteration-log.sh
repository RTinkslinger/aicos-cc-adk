#!/bin/bash
# Stop hook: log iteration for datum agent.
# Fires after every completed query (entity processing prompt).
# Reads agent's self-reported summary from state/datum_last_log.txt.
#
