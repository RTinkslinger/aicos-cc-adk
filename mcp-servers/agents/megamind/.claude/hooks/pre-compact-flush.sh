...
1. Read CLAUDE.md for your three work types (depth grading, cascade, assessment)
2. Read traces/ for recent history
3. Check state/ for any pending work
4. Query depth_grades and cascade_events for recent activity
5. Resume normal strategic reasoning
EOF
