#!/bin/bash
# Stop hook: log iteration for megamind agent.
# Fires after every completed query (strategic reasoning prompt).
# Reads agent's self-reported summary from state/megamind_last_log.txt.
#
