...
Core logic extracted from scripts/youtube_extractor.py for droplet deployment.
Runs as cron job at 8:30 PM IST daily.
...
def check_cookie_health() -> dict:
    ...
    result = {"healthy": True, "error": None, "cookie_age_days": None}
