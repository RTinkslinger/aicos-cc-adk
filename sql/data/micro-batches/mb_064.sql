...
name: "Exitfund"
notion_page_id: "24f29bcc-b6fc-8013-b7a0-caf13e5893ce"
postgres_id: 148
fetched: "2026-03-20"
---
...
### De-brief (if any)' WHERE page_content_path = 'companies-pages/exitfund.md';
UPDATE companies SET page_content = '---
name: "Commsor"
notion_page_id: "bce38e34-9305-491f-afb3-c71efb0a44e3"
postgres_id: 99
fetched: "2026-03-20"
---
...
' WHERE page_content_path = 'companies-pages/commsor.md';
UPDATE companies SET page_content = '---
name: "Fliq (f.k.a. EthosX)"
notion_page_id: "7467f405-f53d-4df6-8d4b-d071bd1cdb86"
postgres_id: 159
fetched: "2026-03-20"
---
...
### Financial Update — Mar 2026 (Audit)

- 2025 Revenue: ~$30,000

- Current Monthly Revenue: ~$5,000

- Jan 2026 Cash Balance: $90,000

- Monthly Burn (current): $20,000

- Burn expected to reduce further — targeting near-zero in 2-3 months' WHERE page_content_path = 'companies-pages/fliq-fka-ethosx.md';
UPDATE companies SET page_content = '---
name: "Firstbase"
notion_page_id: "652d573e-aae5-4f8e-9411-ff920acb299e"
postgres_id: 158
fetched: "2026-03-20"
---
...
' WHERE page_content_path = 'companies-pages/firstbase.md';
UPDATE companies SET page_content = '# Weaver
...
' WHERE page_content_path = 'companies-pages/weaver.md';